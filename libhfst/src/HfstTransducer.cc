...
hfst::implementations::LogWeightTransducer HfstTransducer::log_ofst_interface;
#endif
#endif
#if HAVE_FOMA
...
InitializeXfsm::InitializeXfsm() { initialize_xfsm(); }
...
/* Allow minimization of intermediary results, used in some more complex
   functions. A false value indicates that only epsilon removal and
   determinization is allowed. */
...
void
set_xerox_composition(bool value)
{
    xerox_composition = value;
}

bool
get_xerox_composition()
{
    return xerox_composition;
}

void
set_minimization(bool value)
{
    can_minimize = value;
}
...
void
set_minimize_even_if_already_minimal(bool value)
{
...
bool
get_minimize_even_if_already_minimal()
{
    return minimize_even_if_already_minimal;
}

void
set_flag_is_epsilon_in_composition(bool value)
{
...
bool
get_flag_is_epsilon_in_composition()
{
    return flag_is_epsilon_in_composition;
}

void
set_harmonize_smaller(bool value)
{
    harmonize_smaller = value;
}

bool
get_harmonize_smaller(void)
{
    return harmonize_smaller;
}

void
set_encode_weights(bool value)
{
    encode_weights = value;
}

bool
get_encode_weights(void)
{
    return encode_weights;
}

void
set_warning_stream(std::ostream *os)
{
#if HAVE_OPENFST
...
{
#if HAVE_OPENFST
    return hfst::implementations::TropicalWeightTransducer::
        get_warning_stream();
#else
...
void
set_minimization_algorithm(MinimizationAlgorithm a)
{
...
get_minimization_algorithm()
{
    return minimization_algorithm;
}

void
set_unknown_symbols_in_use(bool value)
{
...
float
HfstTransducer::get_profile_seconds(ImplementationType type)
{
#if HAVE_SFST
    if (type == SFST_TYPE)
...
StringPairSet
HfstTransducer::get_symbol_pairs()
{
#if HAVE_SFST
...
void
HfstTransducer::insert_to_alphabet(const std::string &symbol)
{
    ...
    {
#if HAVE_XFSM
        this->xfsm_interface.add_symbol_to_alphabet(this->implementation.xfsm,
                                                    symbol);
#else
        throw ImplementationTypeNotAvailableException(
            "ImplementationTypeNotAvailableException", __FILE__, __LINE__,
            XFSM_TYPE);
#endif
    }
}
...
void
HfstTransducer::insert_to_alphabet(const std::set<std::string> &symbols)
{
    ...
    {
#if HAVE_XFSM
        this->xfsm_interface.add_symbols_to_alphabet(this->implementation.xfsm,
                                                     symbols);
#else
        throw ImplementationTypeNotAvailableException(
            "ImplementationTypeNotAvailableException", __FILE__, __LINE__,
...
void
HfstTransducer::remove_from_alphabet(const std::string &symbol)
{
...
void
HfstTransducer::remove_from_alphabet(const std::set<std::string> &symbols)
{
    for (const auto &symbol : symbols)
    {
 ...
 * XFSM_TYPE is slow. */
void
HfstTransducer::remove_symbols_from_alphabet(const StringSet &symbols)
{
    if (this->type != XFSM_TYPE)
        HFST_THROW_MESSAGE(FunctionNotImplementedException,
                           "remove_symbols_from_alphabet");
#if HAVE_XFSM
    this->xfsm_interface.remove_symbols_from_alphabet(
        this->implementation.xfsm, symbols);
#endif
    (void)symbols;
}

HfstTransducer &
HfstTransducer::prune_alphabet(bool force)
{
    hfst::implementations::HfstBasicTransducer *net
        = convert_to_basic_transducer();
...
StringSet
HfstTransducer::get_initial_input_symbols() const
{
    switch (type)
    {
#if HAVE_OPENFST
...
StringSet
HfstTransducer::get_first_input_symbols() const
{
    switch (type)
    {
#if HAVE_SFST
...
StringSet
HfstTransducer::get_alphabet() const
{
    switch (type)
    {
#if HAVE_SFST
...
HfstTransducer::harmonize_(const HfstTransducer &another)
{
    ...
    if (this->anonymous && another.anonymous)
    {
        HFST_THROW_MESSAGE(HfstFatalException,
                           "harmonize_ with anonymous transducers");
    }
...
#endif
    {
        HfstBasicTransducer *another_basic
            = another_copy.get_basic_transducer();
...
void
HfstTransducer::harmonize(HfstTransducer &another, bool force /*=false*/)
{
    using namespace implementations;
    if (this->type != another.type)
    {
...
HfstOneLevelPaths *
HfstTransducer::lookup(const StringVector &s, ssize_t limit,
                       double time_cutoff) const
{
    return lookup_fd(s, limit, time_cutoff);
}

HfstOneLevelPaths *
HfstTransducer::lookup(const std::string &s, ssize_t limit,
                       double time_cutoff) const
{
    return lookup_fd(s, limit, time_cutoff);
}
...
HfstTwoLevelPaths *
HfstTransducer::lookup_pairs(const std::string &s, ssize_t limit,
                             double time_cutoff) const
{
    switch (this->type)
    {
    case (HFST_OL_TYPE):
    case (HFST_OLW_TYPE):
        return this->implementation.hfst_ol->lookup_fd_pairs(s, limit,
                                                             time_cutoff);
    default:
...
HfstOneLevelPaths *
HfstTransducer::lookup_fd(const StringVector &s, ssize_t limit,
                          double time_cutoff) const
{
    switch (this->type)
    {
...
HfstOneLevelPaths *
HfstTransducer::lookup_fd(const std::string &s, ssize_t limit,
                          double time_cutoff) const
{
    switch (this->type)
    {
...
HfstOneLevelPaths *
HfstTransducer::lookdown(const StringVector &s, ssize_t limit) const
{
    (void)s;
    (void)limit;
    HFST_THROW(FunctionNotImplementedException);
...
HfstOneLevelPaths *
HfstTransducer::lookdown_fd(StringVector &s, ssize_t limit) const
{
    (void)s;
    (void)limit;
    HFST_THROW(FunctionNotImplementedException);
...
HfstOneLevelPaths *
HfstTransducer::lookdown(const std::string &s, ssize_t limit) const
{
    (void)s;
    (void)limit;
    HFST_THROW(FunctionNotImplementedException);
...
HfstOneLevelPaths *
HfstTransducer::lookdown_fd(const std::string &s, ssize_t limit) const
{
    (void)s;
    (void)limit;
    HFST_THROW(FunctionNotImplementedException);
...
bool
HfstTransducer::is_lookup_infinitely_ambiguous(const StringVector &s) const
{
    switch (this->type)
    {
    ...
    case (HFST_OL_TYPE):
    case (HFST_OLW_TYPE):
        return this->implementation.hfst_ol->is_lookup_infinitely_ambiguous(s);
    default:
        (void)s;
        HFST_THROW(FunctionNotImplementedException);
    }
...
bool
HfstTransducer::is_lookup_infinitely_ambiguous(const std::string &s) const
{
    switch (this->type)
    {
    /* TODO: Convert into HFST_OL(W)_TYPE, if needed. */
...
bool
HfstTransducer::is_lookdown_infinitely_ambiguous(const StringVector &s) const
{
    (void)s;
    HFST_THROW(FunctionNotImplementedException);
}
...
bool
HfstTransducer::is_infinitely_ambiguous() const
{
    switch (this->type)
    {
    case (HFST_OL_TYPE):
...
#if HAVE_OPENFST_LOG
    case LOG_OPENFST_TYPE:
        implementation.log_ofst = log_ofst_interface.create_empty_transducer();
        break;
#endif
#endif
#if HAVE_FOMA
...
#if HAVE_OPENFST_LOG
    case LOG_OPENFST_TYPE:
        implementation.log_ofst = log_ofst_interface.define_transducer(spv);
        break;
#endif
#endif
#if HAVE_FOMA
    case FOMA_TYPE:
        implementation.foma = foma_interface.define_transducer(spv);
        break;
#endif
#if HAVE_XFSM
    case XFSM_TYPE:
        implementation.xfsm = xfsm_interface.define_transducer(spv);
        break;
#endif
    case ERROR_TYPE:
        HFST_THROW(SpecifiedTypeRequiredException);
...
HfstTransducer::HfstTransducer(const StringVector &sv, ImplementationType type)
...
HfstTransducer::HfstTransducer(const StringPairSet &sps,
                               ImplementationType type, bool cyclic)
    : type(type), anonymous(false), is_trie(false), name("")
{
    if (!is_implementation_type_available(type))
        throw ImplementationTypeNotAvailableException(
    ...
    for (const auto &sp : sps)
    {
        if (sp.first.empty() || sp.second.empty())
            HFST_THROW_MESSAGE(EmptyStringException,
                               "HfstTransducer(const StringPairSet&, "
                               "ImplementationType, bool)");
    }
...
#if HAVE_FOMA
    case FOMA_TYPE:
        implementation.foma = foma_interface.define_transducer(sps, cyclic);
        this->type = FOMA_TYPE;
        break;
#endif
#if HAVE_XFSM
    case XFSM_TYPE:
        implementation.xfsm = xfsm_interface.define_transducer(sps, cyclic);
        this->type = XFSM_TYPE;
        break;
#endif
    case ERROR_TYPE:
...
#if HAVE_OPENFST_LOG
    case LOG_OPENFST_TYPE:
        implementation.log_ofst = log_ofst_interface.define_transducer(spsv);
        this->type = LOG_OPENFST_TYPE;
        break;
#endif
#endif
#if HAVE_FOMA
    case FOMA_TYPE:
        implementation.foma = foma_interface.define_transducer(spsv);
        this->type = FOMA_TYPE;
        break;
#endif
#if HAVE_XFSM
    case XFSM_TYPE:
        implementation.xfsm = xfsm_interface.define_transducer(spsv);
        this->type = XFSM_TYPE;
        break;
#endif
    case ERROR_TYPE:
...
#if HAVE_OPENFST
    case TROPICAL_OPENFST_TYPE:
        implementation.tropical_ofst = tropical_ofst_interface.copy(
...
#endif
    case HFST_OL_TYPE:
        implementation.hfst_ol = another.implementation.hfst_ol->copy(
    ...
    : type(type), anonymous(false), is_trie(false), name("")
{
    ...
    case HFST_OL_TYPE:
        implementation.hfst_ol
            = ConversionFunctions::hfst_basic_transducer_to_hfst_ol(&net,
                                                                    false);
        break;
    case HFST_OLW_TYPE:
        implementation.hfst_ol
...
#if HAVE_OPENFST
    case TROPICAL_OPENFST_TYPE:
        tropical_ofst_interface.delete_transducer(
            implementation.tropical_ofst);
        break;
#if HAVE_OPENFST_LOG || HAVE_LEAN_OPENFST_LOG
    case LOG_OPENFST_TYPE:
...
ImplementationType
HfstTransducer::get_type(void) const
{
    return this->type;
}
void
HfstTransducer::set_name(const std::string &name)
{
    this->set_property(std::string("name"), name);
}
std::string
HfstTransducer::get_name() const
{
    return this->get_property(std::string("name"));
}

void
HfstTransducer::set_property(const std::string &property,
...
std::string
HfstTransducer::get_property(const std::string &property) const
{
...
bool
HfstTransducer::compare(const HfstTransducer &another, bool harmonize) const
{
    if (this->type != another.type)
    ...
    case XFSM_TYPE:
        return one_copy.xfsm_interface.are_equivalent(
            one_copy.implementation.xfsm, another_copy.implementation.xfsm);
#endif
    case ERROR_TYPE:
        HFST_THROW(TransducerHasWrongTypeException);
    default:
...
bool
HfstTransducer::is_automaton(void) const
{
    switch (type)
    {
#if HAVE_SFST
...
#if HAVE_OPENFST
    case TROPICAL_OPENFST_TYPE:
        return tropical_ofst_interface.is_automaton(
            implementation.tropical_ofst);
#if HAVE_OPENFST_LOG
    case LOG_OPENFST_TYPE:
...
bool
HfstTransducer::is_cyclic(void) const
{
    switch (type)
    {
#if HAVE_SFST
...
unsigned int
HfstTransducer::number_of_states() const
{
#if HAVE_OPENFST
    if (type == TROPICAL_OPENFST_TYPE)
...
unsigned int
HfstTransducer::number_of_arcs() const
{
#if HAVE_OPENFST
    if (type == TROPICAL_OPENFST_TYPE)
...
#if HAVE_SFST
    if (type == SFST_TYPE)
        return this->sfst_interface.number_of_arcs(this->implementation.sfst);
#endif
#if HAVE_FOMA
    if (type == FOMA_TYPE)
        return this->foma_interface.number_of_arcs(this->implementation.foma);
#endif
#if HAVE_XFSM
    if (type == XFSM_TYPE)
        return this->xfsm_interface.number_of_arcs(this->implementation.xfsm);
#endif
    return 0;
}
...
new_filter(const HfstTransducer &fail_flags,
           const HfstTransducer &succeed_flags, const HfstTransducer &self,
           bool required)
{
...
static void
substitute_escaped_flags(HfstTransducer *filter)
{
...
static int
flag_build(int ftype, char *fname, char *fvalue, int fftype, char *ffname,
           char *ffvalue)
{
    ...
    /* R flag with value */
    if ((ftype == FLAG_REQUIRE) && (fftype == FLAG_POSITIVE) && (eq == 0)
        && !selfnull)
        return FLAG_SUCCEED;
    if ((ftype == FLAG_REQUIRE) && (fftype == FLAG_UNIFY) && (eq == 0)
        && !selfnull)
        return FLAG_SUCCEED;
    if ((ftype == FLAG_REQUIRE) && (fftype == FLAG_POSITIVE) && (eq != 0)
        && !selfnull)
    ...
    /* D flag with value */
    if ((ftype == FLAG_DISALLOW) && (fftype == FLAG_POSITIVE) && (eq != 0)
        && !selfnull)
        return FLAG_SUCCEED;
    if ((ftype == FLAG_DISALLOW) && (fftype == FLAG_CLEAR) && !selfnull)
        return FLAG_SUCCEED;
    if ((ftype == FLAG_DISALLOW) && (fftype == FLAG_NEGATIVE) && (eq == 0)
        && !selfnull)
        return FLAG_SUCCEED;
    if ((ftype == FLAG_DISALLOW) && (fftype == FLAG_POSITIVE) && (eq == 0)
        && !selfnull)
        return FLAG_FAIL;
    if ((ftype == FLAG_DISALLOW) && (fftype == FLAG_UNIFY) && (eq == 0)
        && !selfnull)
        return FLAG_FAIL;
    if ((ftype == FLAG_DISALLOW) && (fftype == FLAG_NEGATIVE) && (eq != 0)
        && !selfnull)
...
static int
hfst_operator_to_char(const std::string &op)
{
    if (op[0] == 'U')
        return FLAG_UNIFY;
    if (op[0] == 'C')
...
static int
is_valid_flag_combination(const std::string &flag1, const std::string &flag2)
{
...
/* @brief Get flag filter for transducer \a transducer.
   ...
   @param flag The flag that is filtered, if empty string, all flags are
   filtered.
   @return The flag filter, if there is nothing to filter, return NULL. */
static HfstTransducer *
get_flag_filter(const HfstTransducer *transducer, const StringSet &flags,
                const String &flag)
{
    ...
    for (const auto &f : flags)
    {
        ...
        if (flag_found)
        {
            HfstTransducer *newfilter
                = new_filter(fail_flags, succeed_flags, self,
                             (FdOperation::get_operator(f)[0] == 'R'));
...
static void
flag_purge(HfstTransducer &transducer, const std::string &flag)
{
    ImplementationType type = transducer.get_type();
...
HfstTransducer::eliminate_flag(const std::string &flag)
{
    ...
    if (!feature_found)
    {
        if (flag.find('.') == std::string::npos)
            HFST_THROW_MESSAGE(HfstException,
                               "HfstTransducer::eliminate_flag: flag feature "
                               "does not occur in the transducer: "
                                   + flag);
        else
            HFST_THROW_MESSAGE(HfstException,
                               "HfstTransducer::eliminate_flag: only the flag "
                               "feature must be given, no value or operator: "
                                   + flag);
    }
    ...
    if (type == FOMA_TYPE)
    {
        struct fsm *result = this->foma_interface.eliminate_flag(
            this->implementation.foma, flag);
        this->implementation.foma = result;
        return *this;
    }
#endif
    ...
    if (type == XFSM_TYPE)
    {
        this->xfsm_interface.eliminate_flag_xfsm(this->implementation.xfsm,
                                                 flag);
        return *this;
    }
#endif
...
HfstTransducer::prune()
{
    ...
    fst::StdVectorFst *temp
        = hfst::implementations::TropicalWeightTransducer::prune(
            this->implementation.tropical_ofst);
    this->tropical_ofst_interface.delete_transducer(
        this->implementation.tropical_ofst);
...
HfstTransducer::extract_path_transducers()
{
    if (this->type != SFST_TYPE)
        HFST_THROW(FunctionNotImplementedException);
    ...
    for (std::vector<SFST::Transducer *>::iterator it = sfst_paths.begin();
         it != sfst_paths.end(); it++)
    {
...
void
HfstTransducer::extract_paths(ExtractStringsCb &callback, int cycles) const
{
    switch (this->type)
    {
#if HAVE_OPENFST
...
void
HfstTransducer::extract_paths_fd(ExtractStringsCb &callback, int cycles,
                                 bool filter_fd) const
{
    ...
    case TROPICAL_OPENFST_TYPE:
    {
        ...
        hfst::implementations::TropicalWeightTransducer::extract_paths(
            implementation.tropical_ofst, callback, cycles, t_tropical_ofst,
            filter_fd);
...
class ExtractStringsCb_ : public ExtractStringsCb
{
  public:
    ...
    RetVal
    operator()(HfstTwoLevelPath &path, bool final)
    {
        if (final)
            paths.insert(path);
...
int
HfstTransducer::longest_path_size(bool obey_flags) const
{
    if (this->is_cyclic())
    {
    ...
    bool paths_found
        = this->extract_longest_paths(results, true /* obey flags */);
    if (!paths_found)
    {
        return -1;
    }
...
static std::string
match_any_n_times(unsigned int n, const StringSet &flags)
{
...
bool
HfstTransducer::extract_longest_paths(
...
void
HfstTransducer::extract_shortest_paths(HfstTwoLevelPaths &results) const
{
#if HAVE_OPENFST
    HfstTransducer t(*this);
    t.convert(TROPICAL_OPENFST_TYPE);
...
void
HfstTransducer::extract_paths(HfstTwoLevelPaths &results, int max_num,
                              int cycles) const
{
...
void
HfstTransducer::extract_paths_fd(HfstTwoLevelPaths &results, int max_num,
                                 int cycles, bool filter_fd) const
{
    if (is_cyclic() && max_num < 1 && cycles < 0)
        HFST_THROW_MESSAGE(TransducerIsCyclicException,
...
void
HfstTransducer::extract_random_paths(HfstTwoLevelPaths &results,
                                     int max_num) const
{
    switch (this->type)
    {
...
void
HfstTransducer::extract_random_paths_fd(HfstTwoLevelPaths &results,
                                        int max_num, bool filter_fd) const
{
#if HAVE_OPENFST
    HfstTransducer copy(*this);
    copy.convert(TROPICAL_OPENFST_TYPE);
...
bool
HfstTransducer::is_special_symbol(const std::string &symbol)
{
    if (symbol.size() < 4)
        return false;
...
StringSet
HfstTransducer::insert_missing_diacritics_to_alphabet_from(
...
void
HfstTransducer::insert_missing_symbols_to_alphabet_from(
    const HfstTransducer &another, bool only_special_symbols)
{
    StringSet this_alphabet = this->get_alphabet();
    StringSet another_alphabet = another.get_alphabet();
...
*/
bool
HfstTransducer::check_for_missing_flags_in(const HfstTransducer &another,
                                           StringSet &missing_flags,
...
void
HfstTransducer::insert_freely_missing_flags_from(const HfstTransducer &another)
{
    StringSet missing_flags;
        ...
        for (unsigned int s = 0; s <= (unsigned int)basic.get_max_state(); ++s)
        {
            for (const auto &missing_flag : missing_flags)
            {
                basic.add_transition(
                    s,
                    HfstBasicTransition(s, missing_flag, missing_flag, 0.0));
            }
        }
...
bool
has_flags(const HfstTransducer &fst)
{
...
bool
HfstTransducer::has_flag_diacritics(void) const
{
    return has_flags(*this);
}

std::string
add_suffix_to_feature_name(const std::string &flag_diacritic,
                           const std::string &suffix)
{
    return "@" + FdOperation::get_operator(flag_diacritic) + "."
...
void
rename_flag_diacritics(HfstTransducer &fst, const std::string &suffix)
{
            ...
            basic_fst_copy.add_transition(
                ...
                HfstBasicTransition(
                    ...
                    FdOperation::is_diacritic(transition.get_input_symbol())
                        ? add_suffix_to_feature_name(
                              transition.get_input_symbol(), suffix)
                        : transition.get_input_symbol(),

                    FdOperation::is_diacritic(transition.get_output_symbol())
                        ? add_suffix_to_feature_name(
                              transition.get_output_symbol(), suffix)
...
void
HfstTransducer::twosided_flag_diacritics()
{
    ...
    for (const auto &states : basic_fst)
    {
        for (const auto &transition : states)
        {
            ...
            {
                hfst::implementations::HfstState new_state
                    = basic_fst_copy.add_state();
                ...
                std::string in = istr;
                std::string out
                    = (istr_is_flag) ? istr : hfst::internal_epsilon;

                basic_fst_copy.add_transition(
                    s, HfstBasicTransition(new_state, in, out, 0 /*?*/));
                ...
                basic_fst_copy.add_transition(
                    new_state,
                    HfstBasicTransition(transition.get_target_state(), in, out,
                                        transition.get_weight() /*?*/));
            }
            else
            {
                basic_fst_copy.add_transition(
                    s, HfstBasicTransition(transition.get_target_state(), istr,
                                           ostr, transition.get_weight()));
            }
        }
...
std::string
encode_flag(const std::string &flag_diacritic)
{
...
std::string
decode_flag(const std::string &flag_diacritic)
{
    if (flag_diacritic[0] != '%'
        || flag_diacritic[flag_diacritic.size() - 1] != '%')
...
void
encode_flag_diacritics(HfstTransducer &fst)
{
    ...
    for (const auto &it : alpha)
    {
        if (it.size() > 4)
        {
            if ((it[0] == '%') && (it[it.size() - 1] == '%'))
            {
                ...
                {
                    std::string msg
                        = "error: reserved symbol '" + str + "' detected";
                    throw msg.c_str();
                }
            }
        }
...
void
decode_flag_diacritics(HfstTransducer &fst)
{
...
// "_1", return true.
bool
is_flag_suffix(const std::string &suffix, const std::string &flag_diacritic)
{
...
void
HfstTransducer::harmonize_flag_diacritics(HfstTransducer &another,
...
bool
HfstTransducer::check_for_missing_flags_in(const HfstTransducer &another) const
{
...
static bool
substitute_input_flag_with_epsilon(const StringPair &sp, StringPairSet &sps)
{
...
static bool
substitute_output_flag_with_epsilon(const StringPair &sp, StringPairSet &sps)
{
...
static bool
substitute_one_sided_flags(const StringPair &sp, StringPairSet &sps)
{
    if (FdOperation::is_diacritic(sp.first)
...
HfstTransducer &
HfstTransducer::insert_freely(const StringPair &symbol_pair, bool harmonize)
{
...
HfstTransducer &
HfstTransducer::insert_freely(const HfstTransducer &tr, bool harmonize)
{
    ...
    if (this->type == XFSM_TYPE)
    {
        this->xfsm_interface.insert_freely(this->implementation.xfsm,
                                           tr.implementation.xfsm);
        return *this;
    }
#endif
    ...
    if (tr_harmonized == NULL)
    { // foma or no harmonization
    ...
    case FOMA_TYPE:
    {
        ...
        if (harmonize)
        {
            this->foma_interface.harmonize(implementation.foma,
...
HfstTransducer &
HfstTransducer::substitute(bool (*func)(const StringPair &sp,
                                        StringPairSet &sps))
{
#if HAVE_XFSM
    if (this->type == XFSM_TYPE)
...
HfstTransducer::substitute(const std::string &old_symbol,
                           const std::string &new_symbol, bool input_side,
                           bool output_side)
{
#if HAVE_XFSM
    if (this->type == XFSM_TYPE)
    ...
    if (false && (this->type == SFST_TYPE && input_side && output_side))
    {
        hfst::implementations::Transducer *tmp
            = this->sfst_interface.substitute(implementation.sfst, old_symbol,
                                              new_symbol);
        sfst_interface.delete_transducer(implementation.sfst);
    ...
    // alphabet
    if (false
        && (this->type == TROPICAL_OPENFST_TYPE && input_side && output_side))
    {
        fst::StdVectorFst *tmp = this->tropical_ofst_interface.substitute(
    ...
    if (this->type == LOG_OPENFST_TYPE && input_side && output_side)
    {
        hfst::implementations::LogFst *tmp
            = this->log_ofst_interface.substitute(implementation.log_ofst,
...
HfstTransducer &
HfstTransducer::substitute_symbol(const std::string &old_symbol,
...
HfstTransducer &
HfstTransducer::substitute_symbol_pair(const StringPair &old_symbol_pair,
                                       const StringPair &new_symbol_pair)
{
    return this->substitute(old_symbol_pair, new_symbol_pair);
}
HfstTransducer &
HfstTransducer::substitute_symbol_pair_with_set(
...
HfstTransducer &
HfstTransducer::substitute_symbol_pair_with_transducer(
    const StringPair &symbol_pair, HfstTransducer &transducer, bool harmonize)
{
    return this->substitute(symbol_pair, transducer, harmonize);
}

HfstTransducer &
HfstTransducer::substitute_symbols(
...
HfstTransducer::substitute(const HfstSymbolSubstitutions &substitutions)
{
    ...
    catch (const FunctionNotImplementedException &e)
    {
        ...
        {
            net->substitute(substitution.first, substitution.second, true,
                            true);
        }
    }
...
HfstTransducer &
HfstTransducer::substitute_symbol_pairs(
                           ...
                           HfstTransducer &transducer, bool harmonize)
{
    ...
    if (this->type == SFST_TYPE)
    {
        ...
        HfstTransducer retval
            = this_copy.substitute(symbol_pair, transducer_copy, harmonize);
    ...
    HfstTransducer pairTransducer(symbol_pair.first, symbol_pair.second,
                                  this->type);
    if (!harmonize)
    {
...
HfstTransducer &
HfstTransducer::set_final_weights(float weight, bool increment)
{
#if HAVE_OPENFST
    if (this->type == TROPICAL_OPENFST_TYPE)
    {
    ...
    if (this->type == LOG_OPENFST_TYPE)
    {
        implementation.log_ofst = this->log_ofst_interface.set_final_weights(
...
HfstTransducer &
HfstTransducer::push_labels(PushType push_type)
{
#if HAVE_OPENFST
    ...
    if (this->type == LOG_OPENFST_TYPE)
    {
        ...
        this->log_ofst_interface.delete_transducer(
...
HfstTransducer &
HfstTransducer::push_weights(PushType push_type)
{
#if HAVE_OPENFST
    bool to_initial_state = (push_type == TO_INITIAL_STATE);
    if (this->type == TROPICAL_OPENFST_TYPE)
...
HfstTransducer::transform_weights(float (*func)(float))
{
    ...
    if (this->type == LOG_OPENFST_TYPE)
    {
        implementation.log_ofst = this->log_ofst_interface.transform_weights(
...
bool
HfstTransducer::has_weights() const
{
#if HAVE_OPENFST
    if (this->type == TROPICAL_OPENFST_TYPE)
    {
        return this->tropical_ofst_interface.has_weights(
            implementation.tropical_ofst);
    }
#if HAVE_OPENFST_LOG
    if (this->type == LOG_OPENFST_TYPE)
...
bool
substitute_single_identity_with_the_other_symbol(const StringPair &sp,
                                                 StringPairSet &sps)
{
...
bool
substitute_unknown_identity_pairs(const StringPair &sp, StringPairSet &sps)
{
    std::string isymbol = sp.first;
    std::string osymbol = sp.second;
                      ...
                      const struct hfst::xre::XreConstructorArguments &args)
{
    ...
    HfstBasicTransducer result
        = hfst::implementations::HfstBasicTransducer::merge(
            this_basic, another_basic, args.list_definitions, markers_added);
    ...
    for (const auto &it : markers_added)
    {
        ...
        std::string worsener_string("[ ? | \"" + marker + "\" ?:? ]* \""
                                    + marker + "\":" + symbol + " ?:0 [ ? | \""
                                    + marker + "\" ?:? | \"" + marker
                                    + "\":" + symbol + " ?:0 ]* ;");
...
HfstTransducer &
HfstTransducer::compose(const HfstTransducer &another, bool harmonize)
{
    is_trie = false;
    ...
    /* If we want flag diacritics to match with identities and unknowns (as
       ...
       If we do not want flags to match with identities and unknowns (the
       default for non-XFSM transducers) and the transducer is of XFSM_TYPE, we
       add flags of first transducer to alphabet of second transducer if they
       are not yet there and vice versa before composition. */
    ...
    else
    {
        if (this->type == XFSM_TYPE)
        {
            diacritics_added_from_another_to_this
                = this->insert_missing_diacritics_to_alphabet_from(
                    *another_copy);
            diacritics_added_from_this_to_another
                = another_copy->insert_missing_diacritics_to_alphabet_from(
                    *this);
        }
    }
    ...
    {
        this->substitute("@_IDENTITY_SYMBOL_@", "@_UNKNOWN_SYMBOL_@", false,
                         true);
        const_cast<HfstTransducer *>(another_copy)
            ->substitute("@_IDENTITY_SYMBOL_@", "@_UNKNOWN_SYMBOL_@", true,
                         false);
    }
    ...
    case SFST_TYPE:
    {
        SFST::Transducer *sfst_temp = this->sfst_interface.compose(
    ...
    case FOMA_TYPE:
    {
        fsm *foma_temp = this->foma_interface.compose(
    ...
    case XFSM_TYPE:
    {
        this->implementation.xfsm = this->xfsm_interface.compose(
            this->implementation.xfsm, another_copy->implementation.xfsm);
        break;
    }
#endif
#if HAVE_HFSTOL
    ...
    else
    {
        if (this->type == XFSM_TYPE)
        {
            this->remove_symbols_from_alphabet(
                diacritics_added_from_another_to_this);
            another_copy->remove_symbols_from_alphabet(
                diacritics_added_from_this_to_another);
        }
    }
...
// operations.
HfstTransducer
get_flag_path_restriction(const StringSet &_1_flags, const StringSet &_2_flags,
                          ImplementationType type)
{
    ...
    basic_restriction.add_transition(
        start_state, HfstBasicTransition(start_state, internal_identity,
                                         internal_identity, 0.0));

    basic_restriction.add_transition(
        seen_2_state, HfstBasicTransition(start_state, internal_identity,
                                          internal_identity, 0.0));
    ...
    for (auto dollar_flag : _1_flags)
    {
        ...
        basic_restriction.add_transition(
            start_state,
            HfstBasicTransition(start_state, dollar_flag, dollar_flag, 0.0));
    }
    ...
    for (auto dollar_flag : _2_flags)
    {
        ...
        basic_restriction.add_transition(
            start_state,
            HfstBasicTransition(seen_2_state, dollar_flag, dollar_flag, 0.0));
    ...
    HfstTransducer restriction(basic_restriction, type);
...
HfstTransducer::remove_illegal_flag_paths(void)
{
    ...
    HfstTransducer restriction
        = get_flag_path_restriction(_1_flags, _2_flags, this->type);
                              ...
                              bool /*harmonize*/)
{
    ...
    retval.substitute(StringPair("@_UNKNOWN_SYMBOL_@", "@_UNKNOWN_SYMBOL_@"),
                      id_or_unk);
...
bool
code_symbols_for_shuffle(const StringPair &sp, StringPairSet &sps)
{
    ...
    if (is_epsilon(sp.first) || is_unknown(sp.first))
    {
        return false;
    }
...
HfstTransducer &
HfstTransducer::shuffle(const HfstTransducer &another, bool)
{
#if HAVE_XFSM
    if (this->type == XFSM_TYPE)
        HFST_THROW(FunctionNotImplementedException);
...
HfstTransducer &
HfstTransducer::compose_intersect(const HfstTransducerVector &v, bool invert,
                                  bool)
{
#if HAVE_XFSM
    if (this->type == XFSM_TYPE)
    ...
    else
    {
        ...
        implementations::ComposeIntersectRulePair *rules
            = new implementations::ComposeIntersectRulePair(first_rule,
                                                            second_rule);
...
HfstTransducer &
HfstTransducer::concatenate(const HfstTransducer &another, bool harmonize)
{
    is_trie = false; // This could be done so that is_trie is preserved
    return apply(
#if HAVE_SFST
...
HfstTransducer &
HfstTransducer::disjunct(const HfstTransducer &another, bool harmonize)
{
    is_trie = false;
    return apply(
#if HAVE_SFST
...
HfstTransducer &
HfstTransducer::intersect(const HfstTransducer &another, bool harmonize)
{
    is_trie = false; // This could be done so that is_trie is preserved
    return apply(
#if HAVE_SFST
...
HfstTransducer &
HfstTransducer::subtract(const HfstTransducer &another, bool harmonize)
{
    is_trie = false; // This could be done so that is_trie is preserved
    return apply(
#if HAVE_SFST
...
HfstTransducer::get_basic_transducer() const
{
#if HAVE_SFST || HAVE_LEAN_SFST
    if (this->type == SFST_TYPE)
    {
...
implementations::HfstBasicTransducer *
HfstTransducer::convert_to_basic_transducer()
{
#if HAVE_SFST || HAVE_LEAN_SFST
    if (this->type == SFST_TYPE)
    {
...
HfstTransducer &
HfstTransducer::convert(const HfstTransducer &t, ImplementationType type)
{
    if (type == ERROR_TYPE)
    {
    ...
    {
        throw ImplementationTypeNotAvailableException(
            "HfstTransducer::convert", __FILE__, __LINE__, type);
    }
...
/* ERROR_TYPE or UNSPECIFIED_TYPE returns true, so they must be handled
   separately */
bool
HfstTransducer::is_implementation_type_available(ImplementationType type)
{
#if !HAVE_FOMA
    if (type == FOMA_TYPE)
        return false;
...
bool
HfstTransducer::is_lean_implementation_type_available(ImplementationType type)
{
#if !HAVE_FOMA
    if (type == FOMA_TYPE)
        return false;
...
HfstTransducer::convert(ImplementationType type, std::string options)
{
...
#if HAVE_FOMA
    case FOMA_TYPE:
        internal = ConversionFunctions::foma_to_hfst_basic_transducer(
            implementation.foma);
        foma_interface.delete_foma(implementation.foma);
        break;
#endif
#if HAVE_XFSM
    case XFSM_TYPE:
        internal = ConversionFunctions::xfsm_to_hfst_basic_transducer(
            implementation.xfsm);
        // delete implementation.xfsm;
        break;
#endif
...
#if HAVE_SFST || HAVE_LEAN_SFST
    case SFST_TYPE:
        internal = ConversionFunctions::sfst_to_hfst_basic_transducer(
            implementation.sfst);
        sfst_interface.delete_transducer(implementation.sfst);
        break;
#endif
#if HAVE_OPENFST
    case TROPICAL_OPENFST_TYPE:
        internal = ConversionFunctions::tropical_ofst_to_hfst_basic_transducer(
            implementation.tropical_ofst);
...
#if HAVE_OPENFST_LOG || HAVE_LEAN_OPENFST_LOG
    case LOG_OPENFST_TYPE:
        internal = ConversionFunctions::log_ofst_to_hfst_basic_transducer(
            implementation.log_ofst);
        log_ofst_interface.delete_transducer(implementation.log_ofst);
        break;
#endif
    case HFST_OL_TYPE:
    case HFST_OLW_TYPE:
        internal = ConversionFunctions::hfst_ol_to_hfst_basic_transducer(
            implementation.hfst_ol);
        delete implementation.hfst_ol;
        break;
#endif
...
void
HfstTransducer::write_in_att_format(const std::string &filename,
...
void
HfstTransducer::write_in_att_format_number(FILE *ofile,
                                           bool print_weights) const
{
#if HAVE_XFSM
    if (this->type == XFSM_TYPE)
...
void
HfstTransducer::write_in_att_format(char *buffer, bool print_weights) const
{
#if HAVE_XFSM
    if (this->type == XFSM_TYPE)
        HFST_THROW(FunctionNotImplementedException);
...
void
HfstTransducer::write_in_att_format(FILE *ofile, bool print_weights) const
{
#if HAVE_XFSM
    if (this->type == XFSM_TYPE)
        HFST_THROW(FunctionNotImplementedException);
...
void
HfstTransducer::write_xfsm_transducer_in_att_format(const char *filename) const
{
    if (type != XFSM_TYPE)
        HFST_THROW(FunctionNotImplementedException);
#if HAVE_XFSM
...
/* Implemented only for XFSM_TYPE. */
void
HfstTransducer::write_xfsm_transducer_in_prolog_format(
...
void
HfstTransducer::write_in_prolog_format(FILE *file, const std::string &name,
                                       bool write_weights)
{
...
HfstTransducer *
HfstTransducer::prolog_file_to_xfsm_transducer(const char *filename)
{
#if HAVE_XFSM
    HfstTransducer *retval = new HfstTransducer(hfst::XFSM_TYPE);
    retval->implementation.xfsm
        = XfsmTransducer::prolog_file_to_xfsm_transducer(filename);
    return retval;
#else
    (void)filename;
    HFST_THROW(FunctionNotImplementedException);
...
HfstTransducer::universal_pair(ImplementationType type)
{
    ...
    bt.add_transition(0, HfstBasicTransition(1, "@_IDENTITY_SYMBOL_@",
                                             "@_IDENTITY_SYMBOL_@", 0));
    bt.add_transition(0, HfstBasicTransition(1, "@_UNKNOWN_SYMBOL_@",
                                             "@_UNKNOWN_SYMBOL_@", 0));
    bt.add_transition(0, HfstBasicTransition(1, "@_UNKNOWN_SYMBOL_@",
                                             "@_EPSILON_SYMBOL_@", 0));
    bt.add_transition(0, HfstBasicTransition(1, "@_EPSILON_SYMBOL_@",
                                             "@_UNKNOWN_SYMBOL_@", 0));
...
HfstTransducer::operator=(const HfstTransducer &another)
{
    ...
    if (this->type != UNSPECIFIED_TYPE && this->type != another.type)
    {
        HFST_THROW_MESSAGE(TransducerTypeMismatchException,
                           "HfstTransducer::operator=");
    }
...
#endif
    case HFST_OL_TYPE:
        implementation.hfst_ol = another_1.implementation.hfst_ol->copy(
            another_1.implementation.hfst_ol, false);
        break;
    case HFST_OLW_TYPE:
        implementation.hfst_ol = another_1.implementation.hfst_ol->copy(
            another_1.implementation.hfst_ol, true);
        break;
    /* Add here your implementation. */
    default:
        (void)1;
...
HfstTokenizer
HfstTransducer::create_tokenizer()
{
    HfstTokenizer tok;
...
HfstTransducer
HfstTransducer::read_lexc(const std::string &filename, ImplementationType type,
                          bool verbose)
{
...
HfstTransducer::read_lexc_ptr(const std::string &filename,
                              ImplementationType type, bool verbose)
{
    if (type == XFSM_TYPE)
    {
        HFST_THROW(FunctionNotImplementedException);
...
std::ostream &
redirect(std::ostream &out, const HfstTransducer &t)
{
    return operator<<(out, t);
}

std::ostream &
operator<<(std::ostream &out, const HfstTransducer &t)
{
#if HAVE_XFSM
    if (t.type == XFSM_TYPE)
        HFST_THROW(FunctionNotImplementedException);
...
void
cross_product_subtest1(ImplementationType type)
{
    HfstTokenizer TOK;
...
void
cross_product_subtest2(ImplementationType type)
{
    HfstTokenizer TOK;
    TOK.add_multichar_symbol("@_UNKNOWN_SYMBOL_@");
...
void
cross_product_subtest3(ImplementationType type)
{
    HfstTokenizer TOK;
    TOK.add_multichar_symbol("@_UNKNOWN_SYMBOL_@");
    TOK.add_multichar_symbol("@_EPSILON_SYMBOL_@");
...
void
cross_product_subtest4(ImplementationType type)
{
...
void
priority_union_test(ImplementationType type)
{
    HfstTokenizer TOK;
    TOK.add_multichar_symbol("@_EPSILON_SYMBOL_@");
    ...
    HfstBasicTransducer btEmpty, btEmptyString, epsilon, bt1, bt2, bt3,
        bt2withoutPriority, btIdentity, btUnknown, btEpsilon, btResult1,
        btResult2, btResult3, btResult4, btResult5, btResult6, btResult7;
    ...
    bt1.add_transition(1,
                       HfstBasicTransition(2, "@_EPSILON_SYMBOL_@", "1", 3));
    ...
    bt2.add_transition(1,
                       HfstBasicTransition(2, "@_EPSILON_SYMBOL_@", "1", 30));
    ...
    bt2withoutPriority.add_transition(
        1, HfstBasicTransition(2, "@_EPSILON_SYMBOL_@", "1", 30));
    ...
    btIdentity.add_transition(0,
                              HfstBasicTransition(0, "@_IDENTITY_SYMBOL_@",
                                                  "@_IDENTITY_SYMBOL_@", 100));
    btIdentity.set_final_weight(0, 100);

    // Unknown to unknown
    btUnknown.add_transition(0,
                             HfstBasicTransition(0, "@_UNKNOWN_SYMBOL_@",
                                                 "@_UNKNOWN_SYMBOL_@", 200));
    btUnknown.set_final_weight(0, 200);

    // Epsilon
    btEpsilon.add_transition(0,
                             HfstBasicTransition(0, "@_EPSILON_SYMBOL_@",
                                                 "@_EPSILON_SYMBOL_@", 300));
    ...
    btResult1.add_transition(
        1, HfstBasicTransition(2, "@_EPSILON_SYMBOL_@", "1", 3));
    ...
    btResult2.add_transition(
        1, HfstBasicTransition(3, "@_EPSILON_SYMBOL_@", "1", 30));
    btResult2.add_transition(
        2, HfstBasicTransition(4, "@_EPSILON_SYMBOL_@", "1", 3));
    ...
    btResult5.add_transition(0,
                             HfstBasicTransition(3, "@_IDENTITY_SYMBOL_@",
                                                 "@_IDENTITY_SYMBOL_@", 200));
    ...
    btResult6.add_transition(0,
                             HfstBasicTransition(0, "@_UNKNOWN_SYMBOL_@",
                                                 "@_UNKNOWN_SYMBOL_@", 200));
    btResult6.add_transition(
        0, HfstBasicTransition(0, "@_UNKNOWN_SYMBOL_@", "b", 200));
    btResult6.add_transition(
        0, HfstBasicTransition(0, "b", "@_UNKNOWN_SYMBOL_@", 200));
    btResult6.add_transition(0, HfstBasicTransition(0, "b", "a", 200));
    btResult6.add_transition(
        0, HfstBasicTransition(0, "@_UNKNOWN_SYMBOL_@", "a", 200));
    btResult6.add_transition(
        0, HfstBasicTransition(0, "a", "@_UNKNOWN_SYMBOL_@", 200));
    ...
    btResult7.add_transition(
        0, HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@", "a", 400));
    btResult7.add_transition(
        0, HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@", "b", 400));
    btResult7.add_transition(0,
                             HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@",
                                                 "@_UNKNOWN_SYMBOL_@", 400));
    btResult7.add_transition(
        0, HfstBasicTransition(3, "b", "@_UNKNOWN_SYMBOL_@", 600));
    btResult7.add_transition(
        0, HfstBasicTransition(3, "a", "@_UNKNOWN_SYMBOL_@", 600));
    btResult7.add_transition(1, HfstBasicTransition(4, "a", "b", 470));
    btResult7.add_transition(1, HfstBasicTransition(4, "b", "a", 470));
    btResult7.add_transition(
        1, HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@", "a", 470));
    btResult7.add_transition(
        1, HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@", "b", 470));
    btResult7.add_transition(1,
                             HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@",
                                                 "@_UNKNOWN_SYMBOL_@", 470));
    btResult7.add_transition(
        1, HfstBasicTransition(4, "b", "@_UNKNOWN_SYMBOL_@", 470));
    btResult7.add_transition(
        1, HfstBasicTransition(4, "a", "@_UNKNOWN_SYMBOL_@", 470));
    btResult7.add_transition(3, HfstBasicTransition(4, "a", "b", 0));
    btResult7.add_transition(3, HfstBasicTransition(4, "b", "a", 0));
    btResult7.add_transition(
        3, HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@", "a", 0));
    btResult7.add_transition(
        3, HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@", "b", 0));
    btResult7.add_transition(3, HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@",
                                                    "@_UNKNOWN_SYMBOL_@", 0));
    btResult7.add_transition(
        3, HfstBasicTransition(4, "b", "@_UNKNOWN_SYMBOL_@", 0));
    btResult7.add_transition(
        3, HfstBasicTransition(4, "a", "@_UNKNOWN_SYMBOL_@", 0));
    btResult7.add_transition(4, HfstBasicTransition(4, "a", "b", 200));
    btResult7.add_transition(4, HfstBasicTransition(4, "b", "a", 200));
    btResult7.add_transition(
        4, HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@", "a", 200));
    btResult7.add_transition(
        4, HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@", "b", 200));
    btResult7.add_transition(4,
                             HfstBasicTransition(4, "@_UNKNOWN_SYMBOL_@",
                                                 "@_UNKNOWN_SYMBOL_@", 200));
    btResult7.add_transition(
        4, HfstBasicTransition(4, "b", "@_UNKNOWN_SYMBOL_@", 200));
    btResult7.add_transition(
        4, HfstBasicTransition(4, "a", "@_UNKNOWN_SYMBOL_@", 200));
    ...
    // TODO the result is wrong, change it! (wrong because of the wights
    // shifting)
    ...
    { // DEBUG
        std::cerr << testTr.priority_union(trIdentity)
                         .push_weights(TO_FINAL_STATE)
                         .minimize()
                  << "--\n"
                  << result4 << std::endl;
    }

    // TODO - results are worng, change them! (wrong because of the wights
    // shifting)
    /*
...
void
universal_pair_test(ImplementationType type)
{
    HfstBasicTransducer bt, bt2, bt3, btResult1, btResult2, btResult3,
        btResult4, btEmpty;
    ...
    btResult1.add_transition(
        0, HfstBasicTransition(1, "a", "@_UNKNOWN_SYMBOL_@", 0));
    btResult1.add_transition(
        0, HfstBasicTransition(1, "a", "@_EPSILON_SYMBOL_@", 0));
    btResult1.set_final_weight(1, 0);
    // Result 2 ( universal pair .o. a:a )
    btResult2.add_transition(0, HfstBasicTransition(1, "a", "a", 0));
    btResult2.add_transition(
        0, HfstBasicTransition(1, "@_UNKNOWN_SYMBOL_@", "a", 0));
    btResult2.add_transition(
        0, HfstBasicTransition(1, "@_EPSILON_SYMBOL_@", "a", 0));
    ...
    btResult4.add_transition(
        0, HfstBasicTransition(1, "@_UNKNOWN_SYMBOL_@", "b", 0));
    btResult4.add_transition(
        0, HfstBasicTransition(1, "@_EPSILON_SYMBOL_@", "b", 0));
...
void
lenient_composition_test(ImplementationType type)
{
    HfstTokenizer TOK;
...
main(int argc, char *argv[])
{
    ...
    ImplementationType types[]
        = { SFST_TYPE, TROPICAL_OPENFST_TYPE, FOMA_TYPE };
    ...
    for (unsigned int i = 0; i < NUMBER_OF_TYPES; i++)
    {
        ...
        void insert_freely_missing_flags_from(const HfstTransducer &another);
        ...
        HfstTransducer a_paths("A"
                               "@P.Char.ON@",
                               flag_tokenizer, types[i]);
        a_paths.concatenate(any);
        HfstTransducer a_end("@R.Char.ON@"
                             "A",
                             flag_tokenizer, types[i]);
        ...
        HfstTransducer b_end("@R.Char.ON@"
                             "B",
                             flag_tokenizer, types[i]);
